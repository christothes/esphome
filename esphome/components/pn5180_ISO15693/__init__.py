...
PN5180_ISO15693IsWritingCondition = pn5180_ISO15693_ns.class_(
    "PN5180_ISO15693IsWritingCondition", automation.Condition
)
            ...
            cv.Optional(CONF_ON_FINISHED_WRITE): automation.validate_automation(
                {
                    cv.GenerateID(CONF_TRIGGER_ID): cv.declare_id(
                        PN5180_ISO15693OnFinishedWriteTrigger
                    ),
                }
            ),
...
async def setup_pn5180_ISO15693(var, config):
...
async def pn5180_ISO15693_is_writing_to_code(config, condition_id, template_arg, args):
...
async def to_code(config):
    ...
    await setup_pn5180_ISO15693(var, config)
